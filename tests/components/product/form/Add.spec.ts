...
import ProductFormAdd from "@@/components/product/form/Add.vue";

describe("Form component", () => {
  it("renders unchanged", async () => {
    const container = await renderSuspended(ProductFormAdd);
