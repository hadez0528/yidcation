...
import ProductFormEdit from "@@/components/product/form/Edit.vue";

describe("ProductFormEdit component", () => {
  const commonOptions = {
    attrs: {
      productId: "test id",
      initialValues: {
  ...
  it("renders unchanged", async () => {
    const container = await renderSuspended(ProductFormEdit, commonOptions);
